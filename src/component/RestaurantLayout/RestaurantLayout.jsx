...
const RestaurantLayout = () => {
  const [restaurantCardData, setRestaurantCardData] = useState(restaurantData);

  const [filterData, setFilterData] = useState(restaurantCardData);
        ...
        <div className="w-[90%] mx-auto grid grid-cols-1 pb-5">
          <div className="flex justify-start items-center gap-4">
            ...
            <button
              className="bg-green-500 text-white font-bold py-2 px-4 rounded mt-4 max-w-60"
              onClick={() => {
                setRestaurantCardData(restaurantData);
              }}>
              All Restaurants
            </button>
              ...
              <button
                ...
                onClick={() => {
                  const filterData = restaurantCardData.filter((e) => {
                    return e.name.toLowerCase() === searchData.toLowerCase();
                  });
